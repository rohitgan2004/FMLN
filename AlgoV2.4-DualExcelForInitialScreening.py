...
def initial_screening(file_path,sheet_name,price_limit,volume_limit,write_file_path):
    df = pd.read_excel(file_path,sheet_name)
    filtered_df = df[(df['Price'] > price_limit) & (df['AverageVolume'] >= volume_limit)]
...
read_file_path = "Tickers-V2.4-read.xlsx"
write_file_path = "Tickers-V2.4-write.xlsx"  
sheet_name = "Sheet1"
volume_threshold = 10000
price_threshold = 1.01

#Beginning of acitve bit -- buy side ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

#Goes through tickers from read sheet, filters those that do not meet the price 
#or volume threshold, and then prints the lisst of them to the write sheet
initial_screening(read_file_path,sheet_name,price_threshold,volume_threshold,write_file_path)
